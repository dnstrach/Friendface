...
class User: Codable {
    ...
    static let example = User(id: UUID(), isActive: true, name: "Dominique Strachan", age: 26, company: "Code Ninjas", email: "ds@gmail.com", address: "27522 Tiara", about: "I work as a coding instructor.", registered: .now, tags: ["code", "ios"], friends: [])
